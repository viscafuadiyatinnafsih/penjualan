        ...
        <div class="gtco-container">
            <div class="row animate-box">
                <div class="col-md-8 col-md-offset-2 text-center gtco-heading">
                    <h2 class="cursive-font"><font color="#DB709">Ayo Shopping!</font></h2>
                    <p>Easy Shopping at Trusted Place</p>
                </div>
            </div>
            <div class="row animate-box">
                <center><a class="btn btn-primary" href="<?php echo site_url() ?>/customer/category">Mulai Shopping</a></center>
            </div>
        </div>
    </div>
